export const UploadIcon = function ({ className, width, height }) {
    return (
        <svg
            className={className}
            width={width}
...
export const HomeIcon = function ({ className, width = '3.2rem', height = '3.2rem' }) {
    return (
        <svg
            width={width}
            data-e2e=""
...
export const HomeActiveIcon = function ({
    className,
    width = '3.2rem',
    height = '3.2rem',
}) {
...
export const FollowingIcon = function ({
    className,
    width = '3.2rem',
    height = '3.2rem',
}) {
...
export const FollowingActiveIcon = function ({
    className,
    width = '3.2rem',
    height = '3.2rem',
}) {
...
export const LiveICon = function ({ className, width = '3.2rem', height = '3.2rem' }) {
    return (
        <svg
            width={width}
            className={className}
...
export const LiveActiveICon = function ({
    className,
    width = '3.2rem',
    height = '3.2rem',
}) {
